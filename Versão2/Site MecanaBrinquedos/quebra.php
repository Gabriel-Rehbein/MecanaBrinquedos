...
-->
    ...
    <main>
        <section class="produtos">
            ...
            <div class="produto">
                <img src="imagens/produtos/quebras/gato.png" alt="Quebra Cabeça">
                <h3>Gato</h3>
                <p>Descrição do Brinquedo.</p>
                <p class="rate">&#9733;&#9733;&#9733;&#9734;&#9734;</p>
                <button id="login-btn" onclick="location.href='descricao_produto_quebra.php'">Comprar</button>
            </div>

            <div class="produto">
                <img src="Imagens/produtos/quebras/olaf.png" alt="Quebra Cabeça">
                <h3>Olaf</h3>
                <p>Descrição do Brinquedo.</p>
                <p class="rate">&#9733;&#9733;&#9733;&#9734;&#9734;</p>
                <button id="login-btn" onclick="location.href='descricao_produto_quebra.php'">Comprar</button>
            ...
            <div class="produto">
                <img src="imagens/produtos/quebras/scooby.png" alt="Quebra Cabeça">
                <h3>Scooby-Doo</h3>
                <p>Descrição do Brinquedo.</p>
                <p class="rate">&#9733;&#9733;&#9733;&#9734;&#9734;</p>
                <button id="login-btn" onclick="location.href='descricao_produto_quebra.php'">Comprar</button>
            ...
            <div class="produto">
                <img src="imagens/produtos/quebras/arcoiris.png" alt="Quebra Cabeça">
                <h3>Arco-Íris</h3>
                <p>Descrição do Brinquedo.</p>
                <p class="rate">&#9733;&#9733;&#9733;&#9734;&#9734;</p>
                <button id="login-btn" onclick="location.href='descricao_produto_quebra.php'">Comprar</button>
            ...
            <div class="produto">
                <img src="imagens/produtos/quebras/elefante.png" alt="Quebra Cabeça">
                <h3>Elefante</h3>
                <p>Descrição do Brinquedo.</p>
                <p class="rate">&#9733;&#9733;&#9733;&#9734;&#9734;</p>
                <button id="login-btn" onclick="location.href='descricao_produto_quebra.php'">Comprar</button>
            ...
            <div class="produto">
                <img src="imagens/produtos/quebras/bichos.png" alt="Quebra Cabeça">
                <h3>Familia Feliz</h3>
                <p>Descrição do Brinquedo.</p>
                <p class="rate">&#9733;&#9733;&#9733;&#9734;&#9734;</p>
                <button id="login-btn" onclick="location.href='descricao_produto_quebra.php'">Comprar</button>
